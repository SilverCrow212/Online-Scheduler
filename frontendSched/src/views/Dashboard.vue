...
<div class="grid">
    ...
    <div class="col-12 lg:col-6 xl:col-6">
        <div class="card mb-0">
            <Calendar v-model="date" inline class="w-full"/>
        </div>
    </div>
    <div class="col-12 lg:col-6 xl:col-6">
        <div class="card mb-0">
            ...
            <span class="text-green-500 font-medium">5/9</span>
            <span class="text-500"><-connected on the calendar, total or Table?</span>
        </div>
    </div>
